...
def extractBookingInfo(booking: bs) -> dict:
    ...
    startDate, endDate = getStartEndDate(dateInfo.get_text(strip=True)) if dateInfo else (None, None)
    ...
    bookingInfo['reservationNumber'] = reservationNumber.get_text(strip=True) if reservationNumber else None
